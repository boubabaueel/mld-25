    ...
    const Footer = () => {
      return (
        <footer className="bg-gray-100 border-t border-gray-300 text-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                <p className="text-xl font-bold tracking-wider text-black">MLD<span className="text-amber-600">LUXURY</span></p>
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  <li><Link to="/about" className="text-gray-700 hover:text-amber-600 transition-colors">About Us</Link></li>
                  <li><Link to="/fleet" className="text-gray-700 hover:text-amber-600 transition-colors">Our Fleet</Link></li>
                  <li><Link to="/services" className="text-gray-700 hover:text-amber-600 transition-colors">Services</Link></li>
                  <li><Link to="/contact" className="text-gray-700 hover:text-amber-600 transition-colors">Contact</Link></li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex mt-4 space-x-4">
                  ...
                  <a href="#" className="text-gray-600 hover:text-amber-600 transition-colors"><Twitter /></a>
            ...
            <div>
              ...
              <div className="mt-4 text-sm text-gray-600">
                <p className="mb-3 font-medium text-gray-700">Complete Coverage</p>
